...
export const CAROUSEL_TABLE_HEADER_CONSTANTS = [
    {key: "no", align: 'center', title: "No", dataIndex: "no", width: "5%", render: (_: any, __: any, index: number) => index + 1},
    {key: "image", title: "Image", dataIndex: "image", width: "85%", },
    {key: "actions", align: 'center', title: "Actions", actionList: CAROUSEL_ACTIONS_CONSTANTS}
]

export const CONTENT_TABLE_HEADER_CONSTANTS = [
    {key: "no", align: 'center', title: "No", dataIndex: "subcat_spec_name", width: "5%", render: (_: any, __: any, index: number) => index + 1},
    ...
    {key: "actions", align: 'center', title: "Actions", actionList: CONTENT_ACTIONS_CONSTANTS}
]
...
export const HISTORY_TIMELINE_TABLE_HEADER_CONSTANTS = [
    ...
    {key: "date", align: 'center', title: "Timeline date", dataIndex: "date", width: "15%",   render: (text: any) => dayjs(text).format('DD-MM-YYYY'),},
    {key: "actions", align: 'center', title: "Actions", actionList: HISTORY_TIMELINE_ACTIONS_CONSTANTS}
]
